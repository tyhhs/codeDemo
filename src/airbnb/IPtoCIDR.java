 ...
 * IPtoCIDR
 * Author: bjtangyunhao
 * Creation date: 2017年09月12日 16:54
 * Modified by: bjtangyunhao
 * Last modified: 2017年09月12日 16:54
 */
public class IPtoCIDR {

    public static void main(String[] args) {
        String start = "255.255.2.4";
        String end = "255.255.2.265";
        List<String> res = range2cidrlist(start, end);
        for(String s : res){
